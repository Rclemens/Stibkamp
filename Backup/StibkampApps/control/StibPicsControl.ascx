<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StibPicsControl.ascx.cs"
    Inherits="StibkampApps.control.StibPicsControl" %>
...
<asp:XmlDataSource ID="xmldata" runat="server" CacheDuration="Infinite"
