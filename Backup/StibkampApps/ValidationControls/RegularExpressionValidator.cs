...
namespace StibkampApps.ValidationControls
{
    ...
    public class RegularExpressionValidator : System.Web.UI.WebControls.RegularExpressionValidator
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (RenderUplevel && !Page.ClientScript.IsClientScriptBlockRegistered("ValidationScript"))
            {
                ...
                script += "function RegularExpressionValidatorEvaluateIsValid(val){\n";
                script += "var value = ValidatorGetValue(val.controltovalidate);";
                script += "var rx = new RegExp(val.validationexpression);";
                script += "if(value == ''||value==val.defaultValueOfInput||!rx.test(value)){\n " +
